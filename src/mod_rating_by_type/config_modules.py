...
MODULE_BAILOUT_PENALTY = 'bailout_penalty'
MODULE_ADJUSTABLE_BONUSES_AND_PENALTIES = 'adjustable_bonuses_penalties'
MODULE_FLIGHT_TIME_BONUS = 'flight_time_bonus'
modules = {MODULE_SPLIT_RANKINGS, MODULE_AMMO_BREAKDOWN, MODULE_IRONMAN_STATS, MODULE_BAILOUT_PENALTY,
           MODULE_FLIGHT_TIME_BONUS, MODULE_ADJUSTABLE_BONUSES_AND_PENALTIES}
